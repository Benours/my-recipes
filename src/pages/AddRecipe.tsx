import { IonLabel, IonInput, IonButton, IonTextarea } from "@ionic/react";
    ...
    return (
        <form action="">
            <div className="whatPlateBruh">
                ...
                <IonInput onIonChange={(event)=>this.setState({namePlate : event.detail.value!})}/>
            </div>
            <div className="daOrigin">
                <IonLabel>
                    Ville
                </IonLabel>
                <IonInput onIonChange={(event) => this.setState({city : event.detail.value!})} />
                <IonLabel>
                    Pays
                </IonLabel>
                <IonInput onIonChange={(event) => this.setState({country : event.detail.value!})} />
            </div>
            ...
            <div className="someText">
                ...
                <IonTextarea autoGrow onIonChange={(event) => this.setState({recipe : event.detail.value!})}></IonTextarea>
            </div>
